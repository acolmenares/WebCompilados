<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_EntradasDevolucionesList, App_Web_4aswonrk" %>
     ...
     <table id="tbl_Interna" border="0" cellpadding="1" cellspacing="0" width="95%" 
        ...
        <td style="width: 80%;"> 
            <asp:Label ID="Label3" runat="server" 
                Text="VISTA GENERAL DE ENTRADAS POR REINTEGROS" Width="100%" 
                CssClass="TitTitulo" BackColor="PeachPuff"></asp:Label><br />
            <asp:Label ID="Label41" runat="server" CssClass="TitMensaje" Text="_" Width="100%" Visible="False"></asp:Label></td>
                ...
                <td colspan="2" align="center">
                        <asp:Panel ID="pnl_buscar" runat="server" HorizontalAlign="Center" Width="100%">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; text-align: left">
                                ...
                                <tr valign="top">
                                    <td style="width: 15%">
                                        <asp:Label ID="Label42" runat="server" Text="Regional" Width="94%"></asp:Label></td>
                                    <td style="width: 15%">
        ...
        <tr valign ="top">
            <td colspan="2">
                    ...
                    <MasterTableView  NoDetailRecordsText="No hay informaci&#243;n." NoMasterRecordsText="No hay informaci&#243;n." DataKeyNames="Id" CommandItemDisplay ="Top" AllowPaging="True">
                        <Columns>
                           <telerik:GridTemplateColumn HeaderText="No." DefaultInsertValue="" UniqueName="TemplateColumn">
                            ...
                            <telerik:GridBoundColumn DataField="Numero_Entrada" HeaderText="Número de Entrada"
                                SortExpression="Numero_Entrada" UniqueName="Numero_Entrada" >
                            ...
                            <telerik:GridBoundColumn DataField="Salida_Traslado.Bodega.Descripcion" HeaderText="Bodega"
                                SortExpression="Salida_Traslado.Bodega.Descripcion" UniqueName="Salida_Traslado.Bodega.Descripcion" >
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="True" />
                            </telerik:GridBoundColumn> 
                            					            
                            <telerik:GridBoundColumn DataField="UsuarioRecibio.Login" HeaderText="Recibido Por"
                                SortExpression="UsuarioRecibio.Login" UniqueName="UsuarioRecibio.Login" >
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="True" />
                            </telerik:GridBoundColumn> 
                    ...
                    <Selecting AllowRowSelect ="True"  />
                     ...
                     <ExportSettings
                       HideStructureColumns="True" filename ="Entradas_Devoluciones" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
                         <Pdf PageWidth="" >
                         </Pdf>
                    </ExportSettings>
