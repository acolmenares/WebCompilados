<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_SalidasAjustes, App_Web_4aswonrk" %>
...
<script type="text/javascript">
    ...
    <div style="text-align: left">
    <asp:ValidationSummary ID="ValidationSummaryFACT" runat="server" ValidationGroup="FACT" ForeColor="Red" />
     </div>
        ...
        <table id="Table1" cellspacing="0" cellpadding="0" border="0" class="ContentTable" style="width: 100%">
            ...
            <td style="width: 75%"> 
                <asp:Label ID="lbl_Titulo" runat="server" 
                    Text="CREACION / MODIFICACION DE AJUSTES DE INVENTARIOS" Width="90%" 
                    ...
                    <table id="tblContenido" class="EditControlsTable" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr  valign="top">
                            <td class="LabelCell" colspan="6" style="background-color: orange;">
                                <asp:Label ID="Label2" runat="server" Font-Bold="True">DATOS DEL DOCUMENTO  DE  AJUSTE DE INVENTARIOS</asp:Label></td>
                        </tr>

                        <tr  valign="top">
                          <td  class="LabelCell" style="width: 17%">
                                <asp:Label ID="lblNumero_Factura_Proveedor" runat="server" Width="90%">Número  de Ajuste</asp:Label></td>
                            <td class="ControlCell" style="width: 17%; text-align: left;">
                                <asp:TextBox id="txt_Numero" runat = "server" Font-Size="X-Small"   MaxLength="10" style="text-align: left"></asp:TextBox>      
                                <asp:RequiredFieldValidator ID="rfv_Numero" runat="server" ControlToValidate="txt_Numero"
                                    ErrorMessage="Debe Digitar Número de Orden de Salida" ValidationGroup="FACT" ForeColor="Red">*</asp:RequiredFieldValidator></td>
                        ...
                        <asp:Label id="lblFecha" runat="server" Width="90%">Fecha</asp:Label></td>
                            <td class="ControlCell" style="width: 17%; text-align: left;">
                                ...
                                <asp:RequiredFieldValidator ID="rfv_Fecha" runat="server" ControlToValidate="rdpfecha"
                                    EnableClientScript="False" ErrorMessage="Falta Fecha de Ajuste" 
                                    ValidationGroup="FACT" ForeColor="Red">*</asp:RequiredFieldValidator></td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="lblNombre_Entrego" runat="server" Width="90%">Nombre Realiza el Ajuste</asp:Label></td>
                            <td class="ControlCell" style="width: 17%; text-align: left;">
                                <asp:TextBox ID="txtNombre_Entrego" runat="server" Font-Size="X-Small" Width="90%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfv_entrega" runat="server" ControlToValidate="txtNombre_Entrego"
                            ...
                            <asp:Label ID="lblSubTablasRegionalId_Regional" runat="server" Width="90%">Regional</asp:Label></td>
                                                                <td class="ControlCell" style="width: 17%; text-align: left;"><asp:dropdownlist id="ddl_Regional" runat="server" Font-Size="X-Small" Width="90%" >
                                                                </asp:DropDownList>
                                                                    <asp:RegularExpressionValidator ID="rev_Regional" runat="server"
                                                                    ControlToValidate="ddl_Regional" EnableClientScript="False" ErrorMessage="Falta Seleccionar la Regional"
                                                                    ValidationExpression="^[1-9]+[0-9]*$" ValidationGroup="FACT" ForeColor="Red">*</asp:RegularExpressionValidator></td>
                                                                <td class="ControlCell" style="width: 17%">
                        <asp:Label id="lblbodega" runat="server" Width="90%">Bodega</asp:Label></td>
                                                                <td class="ControlCell" style="width: 17%; text-align: left;">
                                <asp:dropdownlist id="ddl_Bodegas" runat="server" Font-Size="X-Small" Width="90%" ></asp:dropdownlist>
                                                                    <asp:RegularExpressionValidator ID="rev_Usuario" runat="server" ControlToValidate="ddl_Bodegas"
                                EnableClientScript="False" ErrorMessage="Falta Seleccionar Bodega"
                                ValidationExpression="^[1-9]+[0-9]*$" ValidationGroup="FACT" ForeColor="Red">*</asp:RegularExpressionValidator></td>
                                                                <td class="ControlCell" style="width: 17%">
                        <asp:Label id="Label10" runat="server" Width="90%">Nombre Coordino el Ajuste</asp:Label></td>
                                                                <td class="ControlCell" style="width: 17%; text-align: left;">
                        <asp:TextBox id="txt_Nombre_Recibe" runat = "server" Font-Size="X-Small" Width="90%"></asp:TextBox>      
                            <asp:RequiredFieldValidator ID="rfv_recide" runat="server" ControlToValidate="txt_Nombre_Recibe"
                                ErrorMessage="Debe Digitar nombre de quien recibió la mercancia" ValidationGroup="FACT" ForeColor="Red">*</asp:RequiredFieldValidator></td>
                                                            </tr>
                        <tr>
                            <td  class="LabelCell" style="width: 17%">
                            ...
                            <td class="ControlCell" colspan="5" style="width: 60%; text-align: left;">
                                <asp:TextBox id="txtObservacion" runat = "server" Width="94%" Rows="3" TextMode="MultiLine"></asp:TextBox>
                                <asp:Label ID="LblId" runat="server" Visible="False"></asp:Label></td>
                        </tr>
                        <tr>
                            <td colspan="6">
                                <asp:Panel ID="pnl_aprobaciones" runat="server" visible ="False" Width="100%">
                                     <table style="text-align: center" border="0" cellpadding="0" cellspacing="0" width="100%">  
                                        <tr valign="top">
                                            <td class="LabelCell" style="background-color: orange;" align="left" colspan="6">
                                                <asp:Label ID="Label5" runat="server" Font-Bold="True">SISTEMA DE APROBACION DE AJUSTE</asp:Label></td>
                                        </tr>
                                        <tr  valign="top">
                                            <td class="LabelCell" style="width: 17%; background-color: lightsteelblue;">
                                                <asp:Label ID="Label6" runat="server" Font-Bold="True" Width="90%">Oficial Logística Oficina</asp:Label></td>
                                            <td class="ControlCell" style="width: 17%; background-color: lightsteelblue;">
                                                <asp:Label ID="Label8" runat="server" Font-Bold="True" Width="90%">Oficial Finanzas Oficina</asp:Label>&nbsp;</td>
                                            <td class="ControlCell" style="width: 17%; background-color: lightsteelblue;">
                                                <asp:Label ID="Label9" runat="server" Font-Bold="True" Width="90%">Coordinador Oficina</asp:Label></td>
                                            <td class="ControlCell" style="width: 17%; background-color: peachpuff;">
                                                <asp:Label ID="Label14" runat="server" Font-Bold="True" Width="90%">Coordinador Logística</asp:Label>&nbsp;</td>
                                            <td class="ControlCell" style="width: 17%; background-color: peachpuff;">
                                                <asp:Label ID="Label16" runat="server" Font-Bold="True" Width="90%">Director Financiero</asp:Label></td>
                                            <td class="ControlCell" style="width: 17%; background-color: peachpuff;">
                                                <asp:Label ID="Label17" runat="server" Font-Bold="True" Width="90%">Director Operaciones</asp:Label>&nbsp;</td>
                                        </tr>                                
                                         <tr valign="top">
                                             <td class="LabelCell" style="width: 17%">
                                                 <asp:CheckBox ID="chk_AOL" runat="server" Enabled="False" /></td>
                                             <td class="ControlCell" style="width: 17%">
                                                 <asp:CheckBox ID="chk_AFO" runat="server" Enabled="False" /></td>
                                             <td class="ControlCell" style="width: 17%">
                                                 <asp:CheckBox ID="chk_ACO" runat="server" Enabled="False" /></td>
                                             <td class="ControlCell" style="width: 17%">
                                                 <asp:CheckBox ID="CHK_ACL" runat="server" Enabled="False" /></td>
                                             <td class="ControlCell" style="width: 17%">
                                                 <asp:CheckBox ID="CHK_ADF" runat="server" Enabled="False" /></td>
                                             <td class="ControlCell" style="width: 17%">
                                                 <asp:CheckBox ID="Chk_ADP" runat="server" Enabled="False" /></td>
                                         </tr>
                                    </table>
                                </asp:Panel>
                            </td>
                              ...
                              <table runat="server" id="tbl_ingreso" width="100%" style="border-right: lightslategray thin solid; border-top: lightslategray thin solid; border-left: lightslategray thin solid; border-bottom: lightslategray thin solid; width: 100%;" border="0" cellpadding="0" cellspacing="0" >
                                  ...
                                  <tr  valign="top">
                                      <td class="ControlCell" align="left" colspan="2">
                                          <asp:Label ID="lbl_CantidadAntesEditar" runat="server" Visible="False" Width="1%"></asp:Label></td>
                                  </tr>
                                  <tr  valign="top">
                                      <td class="ControlCell" colspan="2" style="background-color: lemonchiffon; width: 50%;" align="center" id="pnl_asignar">
                                          <div style="width: 100%; text-align: center;">
                                              <asp:Button ID="btn_GuardarAsignacion" runat="server" CssClass="Boton" 
                                                  Text="Guardar" />
                                              <asp:Button ID="btn_nuevaAsignacion" runat="server" CssClass="Boton" 
                                                  Text="Nueva Entrada" />
                                  ...
                                  <tr  valign="top">
                                      <td class="ControlCell" colspan="4" align="center" style="height: 20px">
                                        <div>
                                            <asp:Button ID="btn_Guardar_Producto" runat="server" Text="Guardar Producto" cssClass="Boton"></asp:Button>&nbsp;<asp:Button ID="btn_limpiar" runat="server" Text="Limpiar" cssClass="Boton"></asp:Button></div>
                                      </td>
                                  </tr>
                        ...
                        <tr  valign="top"><td  class="LabelCell" colspan="6" align="right">
                            ...
                            <telerik:RadGrid ID="Rg_Listado" runat="server" AllowSorting="True" GridLines="None" Skin="WebBlue" Width="100%"  
                                    ...
                                    <MasterTableView  NoDetailRecordsText="No hay informaci&#243;n." 
                                        ...
                                        <Columns>
                                           <telerik:GridTemplateColumn HeaderText="No." DefaultInsertValue="" UniqueName="TemplateColumn">
						                    ...
						                    <telerik:GridBoundColumn DataField="Productos.Descripcion" HeaderText="Nombre del Producto"
                                    ...
                                    <ClientSettings EnablePostBackOnRowClick="True" EnableRowHoverStyle ="True"  >
                                     ...
                                     <ExportSettings
                                       HideStructureColumns="True" filename ="SalidasDetalleAjustes" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" 
        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btn_GuardarAsignacion">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="txtCantidad" 
                        UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="rfv_Cantidad" 
                        UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="lblIdProducto" 
                        UpdatePanelCssClass="" />
            ...
            <telerik:AjaxSetting AjaxControlID="btn_nuevaAsignacion">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="dgEntradas" 
                        UpdatePanelCssClass="" />
            ...
            <telerik:AjaxSetting AjaxControlID="btn_Guardar_Producto">
                <UpdatedControls>
