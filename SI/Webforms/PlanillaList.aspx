<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_PlanillaList, App_Web_if2ks1yr" %>
     ...
     <table id="tbl_Interna" border="0" cellpadding="1" cellspacing="0" width="100%" 
        ...
        <td style="width: 80%;"> 
            <asp:Label ID="Label3" runat="server" 
                Text="VISTA GENERAL DE PLANILLA DE PROGRAMACION" Width="100%" 
        ...
        <td style="width: 20%" align="right">
            <asp:ImageButton ID="btn_actualizar1" runat="server" 
                ImageUrl="~/Images/Printer.jpg" ToolTip="Exportar a Excel Alterno" 
                TabIndex="1" PostBackUrl="~/Webforms/DeclaracionExcel.aspx" />
            <asp:ImageButton ID="btn_exportar" runat="server" 
                ImageUrl="~/Images/Excel-icon.png" PostBackUrl="~/Webforms/PlanillaExcel.aspx" 
                TabIndex="1" ToolTip="Generar Planilla de Entrega" />
            ...
            <td colspan="2" align="center" >
                <asp:Panel ID="pnl_buscar" runat="server" Width="100%" HorizontalAlign="Center" Visible="False">
                    ...
                    <tr valign="top">
                        ...
                        <td style="width: 15%">
                            <asp:Label ID="Label10" runat="server" Text="Fecha Inicial Programación" 
                                Width="94%"></asp:Label>
                        </td>
                        <td style="width: 15%">
                        ...
                        <td style="width: 15%">
                            <asp:Label ID="Label44" runat="server" Text="Tipo de Entrega" Width="94%"></asp:Label>
                        </td>
                        <td style="width: 20%">
                    ...
                    <tr valign="top">
                        ...
                        <td style="width: 15%">
                            <asp:Label ID="Label12" runat="server" Text="Fecha Final Programación" 
                                Width="94%"></asp:Label>
                        </td>
                        <td style="width: 15%">
                            <telerik:RadDatePicker ID="rdpfechaFinalProgramacion" runat="server" Culture="es-CO" 
            ...
            <td colspan="2">
				<telerik:RadGrid ID="Rg_Listado" runat="server" AllowSorting="True" GridLines="None" Skin="WebBlue" Width="100%" 
                    ...
                    <MasterTableView  NoDetailRecordsText="No hay informaci&#243;n." NoMasterRecordsText="No hay informaci&#243;n." DataKeyNames="Id" CommandItemDisplay ="Top" AllowPaging="True">
                        <Columns>
                           <telerik:GridTemplateColumn HeaderText="No." DefaultInsertValue="" UniqueName="TemplateColumn">
						    ...
						    <telerik:GridBoundColumn DataField="Declaracion.Horario" HeaderText="H"  HeaderTooltip ="Horario"
                                SortExpression="Declaracion.Horario" UniqueName="Declaracion.Horario" >
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="True" />
                            </telerik:GridBoundColumn> 
					            					            
						    <telerik:GridBoundColumn DataField="Declaracion.Declarante" HeaderText="TD"  HeaderTooltip ="Tipo Declarante"
						    ...
						    <telerik:GridBoundColumn DataField="Declaracion.TipoFamiliaxaEmpacar" HeaderText="TF" HeaderTooltip ="Tipo de Familia Empacar"  
                                SortExpression="Declaracion.TipoFamiliaxaEmpacar" UniqueName="Declaracion.TipoFamiliaxaEmpacar" >
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="True" />
                            </telerik:GridBoundColumn>
                    ...
                    <Selecting AllowRowSelect ="True"  />
                     ...
                     <ExportSettings
                       HideStructureColumns="True" filename ="Declaraciones_Planilla" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
                         <Pdf PageWidth="" >
                         </Pdf>
                    </ExportSettings>
                    <SortingSettings SortToolTip="Clic aqui para ordenar..."  SortedAscToolTip ="Ordenar Ascendente" SortedDescToolTip ="Ordenar Descendente" />
