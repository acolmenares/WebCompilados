<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_Grupos, App_Web_if2ks1yr" %>
   ...
   <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" />
    <asp:Panel runat="server" ID="pnl_principal" DefaultButton ="btnGuardar" Width ="100%">
        <table id="Table2" cellspacing="0" cellpadding="0" border="0" class="ContentTable" style="width: 100%">
            <tr valign="top">
                <td style="width: 75%"> 
                    <asp:Label ID="lbl_Titulo" runat="server" Text="CREACION / MODIFICACION DE GRUPOS" Width="90%" CssClass="TitTitulo" BackColor="PeachPuff"></asp:Label><br />
            ...
            <tr valign="top">
                <td>
                    <table id="tblContenido" class="EditControlsTable" cellspacing="0" cellpadding="0" border="0" width="80%">
                        <tr valign="top">
                            <td class="LabelCell" style="width: 150px; height: 21px">
                                <asp:Label id="lblDescripcion" runat="server" Width="90%">Nombre del Grupo</asp:Label></td>
                            <td class="ControlCell" style="height: 21px; width: 290px;">
                                <asp:TextBox id="txtDescripcion" runat = "server" Width="192px" Font-Size="X-Small" MaxLength="7"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfv_Nombre" runat="server" ControlToValidate="txtDescripcion"
                                    EnableClientScript="False" 
                                    ErrorMessage="Debe digitar nombre de lugar del grupo" ForeColor="Red">*</asp:RequiredFieldValidator></td>
                        </tr>

                        <tr valign="top"><td  class="LabelCell" style="width: 150px; height: 21px;">
                            <asp:Label ID="Label2" runat="server" Width="90%">Regional</asp:Label></td><td class="ControlCell" style="height: 21px; width: 290px;">
                            <asp:DropDownList ID="ddl_Regional" runat="server" AutoPostBack="True" Font-Size="X-Small"
                            Width="200px">
                            </asp:DropDownList>
                                <asp:RegularExpressionValidator ID="rev_Regional" runat="server"
                            ControlToValidate="ddl_Regional" EnableClientScript="False" ErrorMessage="Debe ingresar la regional a la que aplica"
                            ValidationExpression="^[1-9]+[0-9]*$" ForeColor="Red">*</asp:RegularExpressionValidator></td></tr>
                        <tr valign="top">
                            <td class="LabelCell" style="width: 150px">
                                <asp:Label ID="Label1" runat="server" Width="90%">Lugar de Entrega</asp:Label></td>
                            <td class="ControlCell" style="width: 290px">
                                <asp:dropdownlist id="ddl_Lugar_Entrega" runat="server" Width="200px" Font-Size="X-Small" >
                                </asp:dropdownlist>
                                <asp:RegularExpressionValidator ID="rev_LugarEntrega" runat="server"
                                    ControlToValidate="ddl_Lugar_Entrega" EnableClientScript="False" ErrorMessage="Debe ingresar el lugar de entrega al que aplica"
