<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_GruposList, App_Web_4aswonrk" %>
     ...
     <table id="tbl_Interna" border="0" cellpadding="1" cellspacing="0" width="95%" 
        ...
        <td style="width: 80%;"> 
            <asp:Label ID="Label3" runat="server" 
                Text="VISTA GENERAL DE GRUPOS" Width="100%" CssClass="TitTitulo" 
            ...
            <td colspan="2" align="center" >
                        <asp:Panel ID="pnl_buscar" runat="server" Width="100%" Visible="False">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                ...
                                <tr valign="top">
                                    <td style="width: 20%">
                                        <asp:Label ID="Label2" runat="server" Text="Nombre del Grupo " Width="100%"></asp:Label></td>
                                    <td style="width: 25%">
                                        <asp:TextBox ID="txt_descripcion" runat="server" Width="96%" Font-Size="X-Small"></asp:TextBox></td>
                                    <td style="width: 20%">
                                        <asp:Label ID="Label1" runat="server" Text="Lugar de Entrega" Width="100%"></asp:Label></td>
                                    <td style="width: 25%">
                                        <asp:dropdownlist ID="ddl_Lugar_Entrega" runat="server" Width="100%" Font-Size="X-Small">
                                        </asp:dropdownlist></td>
                ...
                <telerik:RadGrid ID="Rg_Listado" runat="server" AllowSorting="True" 
                    ...
                    <MasterTableView  NoDetailRecordsText="No hay informaci&#243;n." NoMasterRecordsText="No hay informaci&#243;n." DataKeyNames="Id" CommandItemDisplay ="Top" AllowPaging="True">
                        <Columns>
                           ...
                           <telerik:GridBoundColumn DataField="Descripcion" HeaderText="Nombre del Grupo"
                                SortExpression="Descripcion" UniqueName="Descripcion" >
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="True" />
                            </telerik:GridBoundColumn>
					            
                           <telerik:GridBoundColumn DataField="Padre" HeaderText="Lugar de Entrega"
                    ...
                    <Selecting AllowRowSelect ="True"  />
                     ...
                     <ExportSettings
                       HideStructureColumns="True" filename ="Grupos" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
                         <Pdf PageWidth="" >
                         </Pdf>
                    </ExportSettings>
