<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_SalidasDonacionesList, App_Web_4aswonrk" %>
     ...
     <table id="tbl_Interna" border="0" cellpadding="1" cellspacing="0" width="95%" 
        ...
        <td style="width: 80%;"> 
            <asp:Label ID="Label31" runat="server" 
                Text="VISTA GENERAL DE SALIDAS POR DONACIONES" Width="100%" 
            ...
            <td colspan="2">
				<telerik:RadGrid ID="Rg_Listado" runat="server" AllowSorting="True" 
                    ...
                    <Selecting AllowRowSelect ="True"  />
                     ...
                     <ExportSettings
                       HideStructureColumns="True" filename ="Salidas_Donaciones" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
                         <Pdf PageWidth="" >
                         </Pdf>
                    </ExportSettings>
