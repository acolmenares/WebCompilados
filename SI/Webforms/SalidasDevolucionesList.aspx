<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_SalidasDevolucionesList, App_Web_if2ks1yr" %>
     ...
     <table id="tbl_Interna" border="0" cellpadding="1" cellspacing="0" width="95%" 
        ...
        <td style="width: 80%;"> 
            <asp:Label ID="Label31" runat="server" 
                Text="VISTA GENERAL DE SALIDAS POR DEVOLUCIONES" Width="100%" 
            ...
            <td colspan="2">
                    ...
                    <MasterTableView  NoDetailRecordsText="No hay informaci&#243;n." NoMasterRecordsText="No hay informaci&#243;n." DataKeyNames="Id" CommandItemDisplay ="Top" AllowPaging="True">
                        <Columns>
                          ...
                          <telerik:GridBoundColumn DataField="Proveedor.Razon_Social" HeaderText="Donado A"
                                SortExpression="Proveedor.Razon_Social" UniqueName="Proveedor.Razon_Social" >
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="True" />
                            </telerik:GridBoundColumn>	
                           ...
                           <telerik:GridBoundColumn DataField="Nombre_Salida" HeaderText="Recibido"
                    ...
                    <Selecting AllowRowSelect ="True"  />
                     ...
                     <ExportSettings
                       HideStructureColumns="True" filename ="Salidas_Devoluciones" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
                         <Pdf PageWidth="" >
                         </Pdf>
                    </ExportSettings>
