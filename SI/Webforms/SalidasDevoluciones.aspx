<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_SalidasDevoluciones, App_Web_if2ks1yr" %>
        ...
        <table id="Table1" cellspacing="0" cellpadding="0" border="0" class="ContentTable" style="width: 100%">
            ...
            <td style="width: 75%; text-align: left;"> 
                <asp:Label ID="lbl_Titulo" runat="server" 
                    Text="CREACION / MODIFICACION DE DEVOLUCIONES " Width="90%" 
                    ...
                    <table id="tblContenido" class="EditControlsTable" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr  valign="top">
                            <td class="LabelCell" colspan="6" style="background-color: orange;">
                                <asp:Label ID="Label2" runat="server" Font-Bold="True">DATOS DE LA DEVOLUCION</asp:Label></td>
                        </tr>

                        <tr  valign="top">
                          <td  class="LabelCell" style="width: 17%">
                                <asp:Label ID="lblNumero_Factura_Proveedor" runat="server" Width="90%">No. Orden de Salida</asp:Label></td><td class="ControlCell" style="width: 17%">
                        ...
                        <asp:Label id="lblFecha" runat="server" Width="90%">Fecha</asp:Label></td>
                            ...
                            <td class="ControlCell" style="width: 17%">
                                                            ...
                                                            <tr  valign="top">
                                                                <td class="LabelCell" style="width: 17%">
                                                                    <asp:Label ID="Label5" runat="server" Width="90%">Proveedor</asp:Label></td>
                                                                <td class="ControlCell" style="width: 17%"><asp:dropdownlist id="ddl_Proveedor" runat="server" Font-Size="X-Small" Width="90%" >
                                                                </asp:DropDownList>
                            ...
                            <asp:Label ID="lblSubTablasRegionalId_Regional" runat="server" Width="90%">Regional</asp:Label></td>
                                                                <td class="ControlCell" style="width: 17%"><asp:dropdownlist id="ddl_Regional" runat="server" Font-Size="X-Small" Width="90%" >
                                                                </asp:DropDownList>
                        ...
                        <asp:TextBox id="txt_Nombre_Recibe" runat = "server" Font-Size="X-Small" Width="90%"></asp:TextBox>      
                            ...
                            <td class="ControlCell" style="width: 17%;">
                                ...
                                <asp:Label id="lblObservacion" runat="server" Width="90%">Observación</asp:Label></td><td class="ControlCell" colspan="5" style="width: 60%">
                        ...
                        <tr  valign="top"><td  class="LabelCell" style="background-color: orange;" colspan="6">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True">PRODUCTOS DE DEVOLUCION</asp:Label></td>
                        </tr>
                        ...
                        <tr  valign="top"><td  class="LabelCell" colspan="6" align="right">
                            <telerik:RadGrid ID="Rg_Listado" runat="server" AllowSorting="True" GridLines="None" Skin="WebBlue" Width="100%"  OnItemCommand="subCommandItem"
                                    ...
                                    <ClientSettings EnablePostBackOnRowClick="True" EnableRowHoverStyle ="True"  >
                                     ...
                                     <ExportSettings
                                       HideStructureColumns="True" filename ="SalidasDetalleDevoluciones" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
