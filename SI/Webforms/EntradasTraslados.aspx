<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_EntradasTraslados, App_Web_4aswonrk" %>
        ...
        <table id="Table2" cellspacing="0" cellpadding="0" border="0" class="ContentTable" style="width: 100%">
            ...
            <td style="width: 75%"> 
                <asp:Label ID="lbl_Titulo" runat="server" 
                    Text="CREACION / MODIFICACION DE TRASLADOS DE INVENTARIOS" Width="90%" 
                    ...
                    <table id="tblContenido" class="EditControlsTable" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr  valign="top">
                            <td class="LabelCell" colspan="6" style="background-color: orange;">
                                <asp:Label ID="Label2" runat="server" Font-Bold="True">DATOS DEL DOCUMENTO DE ENTRADA POR TRASLADO</asp:Label></td>
                        </tr>
                        ...
                        <asp:TextBox id="txtNumero_Entrada" runat = "server" Font-Size="X-Small" MaxLength ="10" style="text-align: center"></asp:TextBox>      
                                <asp:RequiredFieldValidator ID="rfv_NumeroEntrada" runat="server" ControlToValidate="txtNumero_Entrada"
                                    ErrorMessage="Debe Digitar Número de Entrada Interna" 
                        ...
                        <asp:Label id="lblFecha" runat="server" Width="90%">Fecha</asp:Label></td>
                            <td class="ControlCell" style="width: 17%; text-align: left;">
                                ...
                                <asp:RequiredFieldValidator ID="rfv_Fecha" runat="server" ControlToValidate="rdpfecha"
                                    ...
                                    ErrorMessage="Falta Fecha de Recepción de Traslado" ValidationGroup="FACT" 
                                    ForeColor="Red">*</asp:RequiredFieldValidator>
                                </td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="Label8" runat="server" Width="90%">Bodega a Ingresar</asp:Label></td>
                            <td class="ControlCell" style="width: 17%; text-align: left;"><asp:dropdownlist id="ddl_Bodega_Ingresar" runat="server" Font-Size="X-Small" Width="90%" >
                            </asp:DropDownList>
                                <asp:RegularExpressionValidator ID="rev_bodegaIngresar" runat="server" ControlToValidate="ddl_Bodega_Ingresar"
                                    EnableClientScript="False" ErrorMessage="Falta Seleccionar la Bodega a Ingresar"
                        ...
                        <asp:dropdownlist id="ddl_Regional" runat="server" Font-Size="X-Small" Width="90%" AutoPostBack="True" >
                            ...
                            <asp:RegularExpressionValidator ID="rev_Regional" runat="server" ControlToValidate="ddl_Regional"
                                ...
                                ValidationGroup="FACT" ForeColor="Red">*</asp:RegularExpressionValidator></td>
                                                                <td class="ControlCell" style="width: 17%">
                        <asp:Label id="Label1" runat="server" Width="90%">Seleccione la Salida </asp:Label></td>
                                                                <td class="ControlCell" style="width: 17%; text-align: left;">
                                                                    <asp:dropdownlist id="ddl_Salidas" runat="server" Font-Size="X-Small" Width="90%" AutoPostBack="True" ></asp:dropdownlist>
                            <asp:RegularExpressionValidator ID="rev_salidas" runat="server" ControlToValidate="ddl_Salidas"
                                EnableClientScript="False" ErrorMessage="Falta Seleccionar Proveedor" ValidationExpression="^[1-9]+[0-9]*$"
                                ValidationGroup="FACT" ForeColor="Red">*</asp:RegularExpressionValidator></td>
                                                                <td class="ControlCell" style="width: 17%">
                                                                    <asp:Label ID="lblProveedores" runat="server" Width="90%">Regional Que envia</asp:Label></td>
                                                                <td class="ControlCell" style="width: 17%; text-align: left;"><asp:dropdownlist id="ddl_Regional_Envio" runat="server" Font-Size="X-Small" Width="90%" Enabled="False" >
                                                                </asp:DropDownList>
                                                                    <asp:RegularExpressionValidator ID="rev_RegionalEnvia" runat="server" ControlToValidate="ddl_Regional_Envio"
                                                                        EnableClientScript="False" ErrorMessage="Falta Seleccionar Regional de Envio"
                                                                        ValidationExpression="^[1-9]+[0-9]*$" ValidationGroup="FACT" 
                                                                        ForeColor="Red">*</asp:RegularExpressionValidator></td>
                                                            </tr>
                        <tr  valign="top">
                        ...
                        <asp:Label id="lblUsuariosRecibio" runat="server" Width="90%">Recibido Por </asp:Label></td>
                            ...
                            <td class="ControlCell" style="width: 17%">
                        <asp:Label id="lblNombre_Entrego" runat="server" Width="90%">Entregado Por</asp:Label></td>
                            <td class="ControlCell" style="width: 17%; text-align: left;">
                        <asp:TextBox id="txtNombre_Entrego" runat = "server" Font-Size="X-Small" Width="90%" Enabled="False"></asp:TextBox>      
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtNombre_Entrego"
                                ErrorMessage="Debe Digitar nombre de quien entregó la mercancia" 
                                    ValidationGroup="FACT" ForeColor="Red">*</asp:RequiredFieldValidator></td>
                            <td class="ControlCell" style="width: 17%;">
                                <asp:Label ID="Label7" runat="server" Width="90%">A recibir Por</asp:Label></td>
                                                                        <td class="ControlCell" 
                                style="width: 17%; text-align: left;">
                                                                            <asp:TextBox ID="txtNombre_Recibe" runat="server" Enabled="False" Font-Size="X-Small"
                                                                                Width="90%"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtNombre_Entrego"
                                                                                ErrorMessage="Debe Digitar nombre de quien entregó la mercancia" 
                                                                                ValidationGroup="FACT" ForeColor="Red">*</asp:RequiredFieldValidator></td>
                                                                    </tr>
                                ...
                                <asp:TextBox id="txtObservacion" runat = "server" Font-Size="X-Small" Width="94%" Rows="2" TextMode="MultiLine"></asp:TextBox>
                                <asp:Label ID="LblId" runat="server" Visible="False"></asp:Label></td></tr>
                         <tr style="background-color: #F7F7F7;" >
                            <td align="center" colspan="6">
                                <div>
                                    <asp:Button ID="btnGuardar" runat="server" Text="Guardar" cssClass="Boton"></asp:Button><asp:Button ID="btnGuardarOtro" runat="server" Text="Guardar y agregar otro" cssClass="Boton"></asp:Button>
                                    <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" cssClass="Boton"></asp:Button>&nbsp;</div>
                            </td>
                        </tr>
                            ...
                            <asp:panel ID="pnl_producto" runat="Server" Width="100%" Visible="False" BackColor="NavajoWhite">
                              <table runat="server" id="tbl_ingreso" width="100%" style="border-right: lightslategray thin solid; border-top: lightslategray thin solid; border-left: lightslategray thin solid; border-bottom: lightslategray thin solid" border="0" cellpadding="0" cellspacing="0" >
                                ...
                                <tr  valign="top">
                                    ...
                                    <td class="ControlCell" style="width: 25%; background-color: #ffffcc;" align="left">
                                        <asp:Label ID="Label9" runat="server" Width="90%">Fecha de Vencimiento</asp:Label>
                                    </td>
                                    <td class="ControlCell" style="width: 25%; background-color: #ffffcc;" align="left">
                                                ...
                                                Mode="NumericPages" />
                                                      ...
                                                      <Columns>
                                                          ...
                                                          <asp:TemplateColumn HeaderText="Cantidad" SortExpression="Cantidad">
                                                              <ItemTemplate>
                                                                  <%#String.Format("{0:n0}", Container.DataItem.Cantidad)%>
                                                              </ItemTemplate>
                                  ...
                                  <tr  valign="top">
                                      <td class="ControlCell" colspan="2" style="background-color: lemonchiffon; width: 50%;" align="center" id="pnl_asignar">
                                          <div style="width: 86%">
                                              <asp:Button ID="btn_GuardarAsgnacion" runat="server" CssClass="Boton" 
                                                  Text="Guardar" />
                        ...
                        <tr  valign="top"><td  class="LabelCell" colspan="6" align="right">
				                <telerik:RadGrid ID="Rg_Listado" runat="server" AllowSorting="True" GridLines="None" Skin="WebBlue" Width="100%"  OnItemCommand="subCommandItem"
                                    ...
                                    <ClientSettings EnablePostBackOnRowClick="True" EnableRowHoverStyle ="True"  >
                                     ...
                                     <ExportSettings
                                       HideStructureColumns="True" filename ="DetalleEntradasTraslados" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" 
        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="ddl_Salidas">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="ddl_Regional_Envio" 
                        UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="txtNombre_Entrego" 
                        UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="txtNombre_Recibe" 
                        UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btnGuardar">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="ddl_Bodega_Ingresar" />
            ...
            <telerik:AjaxSetting AjaxControlID="btnGuardarOtro">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="ddl_Salidas" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="ddl_Regional_Envio" 
                        UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="ddlUsuarios" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="txtNombre_Entrego" 
                        UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="txtNombre_Recibe" 
                        UpdatePanelCssClass="" />
            ...
            <telerik:AjaxSetting AjaxControlID="dgAsignacion">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="dgAsignacion" 
                        UpdatePanelCssClass="" />
            ...
            <telerik:AjaxSetting AjaxControlID="btn_GuardarAsgnacion">
                <UpdatedControls>
