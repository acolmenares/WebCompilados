<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_EntradasDevolucionesEntrega, App_Web_if2ks1yr" %>
        ...
        <table id="Table2" cellspacing="0" cellpadding="0" border="0" class="ContentTable" style="width: 100%">
            ...
            <td style="width: 75%; text-align: left;"> 
                <asp:Label ID="lbl_Titulo" runat="server" 
                    Text="CONSULTA DE DEVOLUCIONES DE MERCANCIA EN ENTREGA (AUTOMATICAS)" Width="90%" 
                    ...
                    <table id="tblContenido" class="EditControlsTable" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr  valign="top">
                            <td class="LabelCell" colspan="6" style="background-color: orange;">
                                <asp:Label ID="Label2" runat="server" Font-Bold="True">DATOS DEL DOCUMENTO DE DEVOLUCION</asp:Label></td>
                        </tr>

                        <tr  valign="top">
                          <td  class="LabelCell" style="width: 17%">
                        <asp:Label id="lblProveedores" runat="server" Width="90%">Devuelto por :</asp:Label></td>
                        ...
                        <asp:Label id="lblUsuariosRecibio" runat="server" Width="90%">Recibido Por </asp:Label></td>
                            <td class="ControlCell" style="width: 17%; text-align: left;">
                                <asp:dropdownlist id="ddlUsuarios" runat="server" Font-Size="X-Small" Width="90%" ></asp:dropdownlist>        
                            <asp:RegularExpressionValidator ID="rev_Usuarios" runat="server" ControlToValidate="ddlUsuarios"
                                               ...
                                               <asp:DataGrid ID="dgAsignacion" runat="server" AllowPaging="True"
                                                ...
                                                Mode="NumericPages" />
                                                      ...
                                                      <Columns>
                                                          ...
                                                          <asp:EditCommandColumn EditText="Abrir" HeaderImageUrl ="~/Images/Edit1.gif"  Visible = "False">
                                                              <HeaderStyle Width="50px" />
                                                              <ItemStyle Width="50px" HorizontalAlign ="Right" />
                                                          </asp:EditCommandColumn>
                                                          <asp:TemplateColumn>
                                                              <ItemTemplate>
                                                                  <asp:ImageButton runat="server" ID="btneliminarasig" CommandName ="EliminarAsignacion"  ImageUrl ="~/Images/delete.gif" ToolTip ="Eliminar Asignación" Visible = "False" />
                                                              </ItemTemplate>
                                      ...
                                      <td class="ControlCell" colspan="2" style="background-color: lemonchiffon; width: 50%;" align="center" id="pnl_asignar">
                                          <div style="width: 86%">
                                              ...
                                              <asp:Button ID="btn_nuevaasignacion" runat="server" CssClass="Boton" 
                                                  Text="Nueva Asignación" Visible="False" />
                                      ...
                                      <td class="ControlCell" colspan="4" align="center">
                                        <div>
                                            <asp:Button ID="btn_GuardarProducto" runat="server" Text="Guardar Producto" 
                                                cssClass="Boton" Visible="False"></asp:Button>&nbsp;<asp:Button 
                                                ID="btn_limpiar" runat="server" Text="Limpiar" cssClass="Boton" Visible="False"></asp:Button></div>
                                      </td>
                                  </tr>
                        ...
                        <tr  valign="top"><td  class="LabelCell" colspan="6" align="right">
                                    ...
                                    <MasterTableView  NoDetailRecordsText="No hay informaci&#243;n." 
                                        ...
                                        <Columns>
                                           <telerik:GridTemplateColumn HeaderText="No." DefaultInsertValue="" UniqueName="TemplateColumn">
                                            ...
                                            <telerik:GridButtonColumn ConfirmText="Desea eliminar este registro?" ConfirmDialogType ="Classic"   HeaderTooltip = "Eliminar Producto del Ajuste " HeaderText ="X" Visible = "False"
                            ...
                            <asp:Button ID="btn_nuevo_Producto" runat="server" CssClass="Boton" 
                                    Text="Nuevo Producto" Visible="False" />
                            </div>
                            </td>
                        ...
                        <tr  valign="top"><td  class="LabelCell" style="background-color: #ff6633; text-align: center;" colspan="6">
                            <asp:Label ID="Label4" runat="server" Font-Bold="True">FIN DE LA DEVOLUCION</asp:Label></td>
                        </tr>
                    </table>
                </td>
            </tr>
