<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_SalidasEntregasList, App_Web_if2ks1yr" %>
        ...
        <table id="tbl_Interna" border="0" cellpadding="1" cellspacing="0" width="100%" 
            ...
            <tr valign ="top">
                <td style="width: 80%;"> 
                    ...
                    Text="VISTA GENERAL DE SALIDAS POR ENTREGAS " Width="100%" 
                    ...
                    <telerik:RadGrid ID="Rg_Listado" runat="server" AllowSorting="True" 
                        ...
                        <MasterTableView  NoDetailRecordsText="No hay informaci&#243;n." NoMasterRecordsText="No hay informaci&#243;n." DataKeyNames="Id" CommandItemDisplay ="Top" AllowPaging="True">
                            <Columns>
                               ...
                               <telerik:GridBoundColumn DataField="Reg_Grupo.Descripcion" HeaderText="Grupo"
                               ...
                               <telerik:GridBoundColumn DataField="Dias_Entrega" HeaderText="Días"
                                    SortExpression="Dias_Entrega" UniqueName="Dias_Entrega" >
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Center" Wrap="True" />
                                </telerik:GridBoundColumn>
                        ...
                        <Selecting AllowRowSelect ="True"  />
                         ...
                         <ExportSettings
                           HideStructureColumns="True" filename ="Salidas_Entregas" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
                             <Pdf PageWidth="" >
                             </Pdf>
                        </ExportSettings>
