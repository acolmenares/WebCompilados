<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_EntradasDevoluciones, App_Web_4aswonrk" %>
...
<script type="text/javascript">
          ...
          <table id="Table2" cellspacing="0" cellpadding="0" border="0" class="ContentTable" style="width: 100%">
            ...
            <td style="width: 75%"> 
                <asp:Label ID="lbl_Titulo" runat="server" 
                    Text="CREACION / MODIFICACION DE REINTEGROS DE MERCANCIA" Width="90%" 
                    ...
                    <table id="tblContenido" class="EditControlsTable" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr valign="top">
                            <td class="LabelCell" colspan="6" style="background-color: orange;">
                                <asp:Label ID="Label2" runat="server" Font-Bold="True">DATOS DEL DOCUMENTO DE ENTRADA POR DEVOLUCION</asp:Label></td>
                        </tr>
                        <tr valign="top">
                            <td class="LabelCell" style="width: 17%">
                                <asp:Label ID="lblNumero_Entrada" runat="server" Width="90%">Número de Devolución</asp:Label></td>
                            ...
                            <td class="ControlCell" style="width: 17%">
                                ...
                                <asp:RequiredFieldValidator ID="rfv_Fecha" runat="server" ControlToValidate="rdpFecha"
                                    ...
                                    ValidationGroup="FACT" ForeColor="Red">*</asp:RequiredFieldValidator>
                                </td>
                            <td class="ControlCell" style="width: 17%">
                            </td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="LblId" runat="server" Visible="False"></asp:Label>
                                <asp:Label ID="Lbl_idRegional" runat="server" Visible="False"></asp:Label></td>
                        </tr>
                        <tr valign="top">
                            <td class="LabelCell" style="width: 17%">
                                <asp:Label ID="Label9" runat="server" Width="90%">Seleccione la Salida</asp:Label></td>
                            <td class="ControlCell" style="width: 17%; text-align: left;">
                                <asp:DropDownList ID="ddl_Salidas" runat="server" Font-Size="X-Small" Width="90%"
                                    AutoPostBack="True">
                                </asp:DropDownList>
                                <asp:RegularExpressionValidator ID="rev_salida" runat="server" ControlToValidate="ddl_Salidas"
                                    EnableClientScript="False" ErrorMessage="Falta Seleccionar Salida" ValidationExpression="^[1-9]+[0-9]*$"
                                    ValidationGroup="FACT" ForeColor="Red">*</asp:RegularExpressionValidator></td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="Label7" runat="server" Width="90%">Nombre Entrega</asp:Label></td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="lbl_Entregado" runat="server" Font-Bold="True" ForeColor="Maroon"
                                    Width="90%">Entregado Por</asp:Label></td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="lblUsuariosRecibio" runat="server" Width="90%">Recibido Por </asp:Label></td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:DropDownList ID="ddl_Usuarios" runat="server" Font-Size="X-Small" Width="90%">
                                </asp:DropDownList>
                                <asp:RegularExpressionValidator ID="rev_Usuarios" runat="server" ControlToValidate="ddl_Usuarios"
                                    EnableClientScript="False" ErrorMessage="Falta Seleccionar Usuario que recibio"
                                    ValidationExpression="^[1-9]+[0-9]*$" ValidationGroup="FACT" 
                        ...
                        <tr valign="top">
                            ...
                            <td class="ControlCell" style="width: 17%; text-align: left;">
                                <asp:Label ID="lbl_regional" runat="server" Font-Bold="True" ForeColor="Maroon" Width="90%">Regional</asp:Label></td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="lblNombre_Entrego" runat="server" Width="90%">Bodega</asp:Label></td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="lbl_Bodega" runat="server" Font-Bold="True" ForeColor="Maroon" Width="90%">Regional</asp:Label></td>
                            <td class="ControlCell" style="width: 17%;">
                                <asp:Label ID="lblIdentificacion_Entrego" runat="server" Width="90%">Proveedor</asp:Label></td>
                            <td class="ControlCell" style="width: 17%;">
                                <asp:Label ID="lbl_proveedor" runat="server" Font-Bold="True" ForeColor="Maroon"
                                    Width="90%">Sin Dato</asp:Label></td>
                        </tr>
                        <tr valign="top">
                            <td class="LabelCell" style="width: 17%">
                            ...
                            <td class="ControlCell" colspan="5" style="width: 60%; text-align: left;">
                                <asp:TextBox ID="txtObservacion" runat="server" Width="94%" Rows="3" TextMode="MultiLine"></asp:TextBox></td>
                        </tr>
                        ...
                        <tr valign="top">
                            <td class="LabelCell" style="background-color: orange;" colspan="6">
                        ...
                        <tr valign="top">
                            <td class="LabelCell" colspan="6" align="center" valign="middle">
                                <asp:Panel ID="pnl_producto" runat="Server" Width="100%" Visible="False" BackColor="NavajoWhite">
                                    <table runat="server" id="tbl_ingreso" width="100%" style="border-right: lightslategray thin solid;
                                        border-top: lightslategray thin solid; border-left: lightslategray thin solid;
                                        border-bottom: lightslategray thin solid" border="0" cellpadding="0" cellspacing="0">
                                        <tr valign="top">

                                            <td class="ControlCell" style="width: 25%; background-color: lightsalmon;" align="center"
                                                colspan="2">
                                            ...
                                            <td class="ControlCell" style="width: 25%; background-color: #ffffcc;" align="left">
                                                <asp:Label ID="Label8" runat="server" Width="90%">Fecha de Vencimiento</asp:Label></td>
                                            <td class="ControlCell" style="width: 25%; background-color: #ffffcc;" align="left">
                                        ...
                                        <tr valign="top">
                                            <td class="ControlCell" style="width: 25%; background-color: #ffffcc; height: 19px;"
                                                align="left">
                                                <asp:Label ID="Label1" runat="server" Width="90%">Seleccione Producto de la Entrada</asp:Label></td>
                                            <td class="ControlCell" style="width: 25%; background-color: #ffffcc; height: 19px;"
                                                align="left">
                                                <asp:DropDownList ID="ddl_ItemsSalida" runat="server" Font-Size="X-Small" Width="90%" AutoPostBack="True">
                                                </asp:DropDownList></td>
                                            <td class="ControlCell" style="width: 25%; background-color: #ffffcc; height: 19px;"
                                                align="left">
                                                <asp:Label ID="lblSubTablasProductoId_Producto" runat="server" Width="90%">Producto</asp:Label></td>
                                            <td class="ControlCell" style="width: 25%; background-color: #ffffcc; height: 19px;"
                                                align="left">
                                                <asp:DropDownList ID="ddl_Productos" runat="server" Font-Size="X-Small" Width="90%"
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td class="ControlCell" style="width: 25%; background-color: #ffffcc;" align="left">
                                                <asp:TextBox ID="txtCantidad" runat="server" Font-Size="X-Small" Style="text-align: right"
                                                    MaxLength="10" onkeypress="return ValNumero(this, event)"></asp:TextBox>
                                            ...
                                            <td class="ControlCell" style="width: 25%; background-color: #ffffcc;" align="left">
                                                <asp:DropDownList ID="ddl_capacidad" runat="server" Font-Size="X-Small" Width="90%"
                                                    Enabled="False">
                                                </asp:DropDownList>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td class="ControlCell" style="width: 25%; background-color: #ffffcc;" align="left">
                                                <asp:TextBox ID="txtValor_Unitario" runat="server" onkeypress="return ValNumero(this, event)"
                                                    MaxLength="10" Font-Size="X-Small" Style="text-align: right"></asp:TextBox>
                                        ...
                                        <tr valign="top">
                                            <td class="ControlCell" colspan="4" valign="top" style="background-color: #ffffcc"
                                                align="center">
                                                <table border="0" cellpadding="0" cellspacing="0" id="dist_bodegas" width="80%">
                                                    <tr>
                                                        <td colspan="2" rowspan="5" align="left" valign="top" style="width: 50%">
                                                            <asp:DataGrid ID="dgAsignacion" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                CellPadding="2" ForeColor="Black" GridLines="None" OnItemCommand="subCommandItemAsignacion"
                                                                OnPageIndexChanged="CambioPaginaAsignacion" Width="96%" PageSize="3" BackColor="LightGoldenrodYellow"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn>
                                                                        <ItemTemplate>
                                                                            <asp:ImageButton runat="server" ID="btneliminarasig" CommandName="EliminarAsignacion"
                                                                                ImageUrl="~/Images/delete.gif" ToolTip="Eliminar Asignación" />
                                                                        </ItemTemplate>
                                                        ...
                                                        <td class="ControlCell" colspan="2" style="background-color: lemonchiffon; width: 50%;"
                                                            align="center">
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td class="ControlCell" style="width: 25%" align="left">
                                                            <asp:DropDownList ID="ddl_bodegas" runat="server" Font-Size="X-Small" Width="90%">
                                                            </asp:DropDownList>
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td class="ControlCell" style="width: 25%" align="left">
                                                            <asp:TextBox ID="txt_cantidadbodega" runat="server" Font-Size="X-Small" Style="text-align: right"
                                                                onkeypress="return ValNumero(this, event)" MaxLength="10"></asp:TextBox>
                                            ...
                                            <td class="ControlCell" colspan="4" align="center">
                                                <div>
                                                    <asp:Button ID="btn_GuardarProducto" runat="server" Text="Guardar Producto" 
                                                        CssClass="Boton"></asp:Button>&nbsp;<asp:Button
                                                        ID="btn_limpiar" runat="server" Text="Limpiar" CssClass="Boton"></asp:Button></div>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                            ...
                            <td class="LabelCell" colspan="6" align="right">
 				                <telerik:RadGrid ID="Rg_Listado" runat="server" AllowSorting="True" GridLines="None" Skin="WebBlue" Width="100%"  OnItemCommand="subCommandItem"
                                    ...
                                    <ClientSettings EnablePostBackOnRowClick="True" EnableRowHoverStyle ="True"  >
                                     ...
                                     <ExportSettings
                                       HideStructureColumns="True" filename ="DetalleEntradasDevoluciones" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
                        ...
                        <tr valign="top">
                            <td class="LabelCell" style="background-color: #ff6633; text-align: center;" colspan="6">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" 
        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="ddl_Salidas">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Lbl_idRegional" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="lbl_Entregado" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="lbl_regional" 
                        UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="lbl_Bodega" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="lbl_proveedor" 
                        UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="ddl_ItemsSalida" 
                        UpdatePanelCssClass="" />
            ...
            <telerik:AjaxSetting AjaxControlID="btnGuardar">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="rdpFecha" 
                        UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="rfv_Fecha" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="LblId" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="ddl_Salidas" 
                        UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="ddl_Usuarios" 
                        UpdatePanelCssClass="" />
            ...
            <telerik:AjaxSetting AjaxControlID="ddl_ItemsSalida">
                <UpdatedControls>
