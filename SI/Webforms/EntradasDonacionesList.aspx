<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_EntradasDonacionesList, App_Web_4aswonrk" %>
     ...
     <table id="tbl_Interna" border="0" cellpadding="1" cellspacing="0" width="95%" 
        ...
        <td style="width: 80%;"> 
            <asp:Label ID="Label3" runat="server" 
                Text="VISTA GENERAL DE ENTRADAS POR DONACIONES" Width="100%" 
                        ...
                        <asp:Panel ID="pnl_buscar" runat="server" HorizontalAlign="Center" Width="100%" Visible="False">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; text-align: left">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="width: 15%">
                                        <asp:DropDownList ID="ddl_regional" runat="server" Font-Size="X-Small" Width="90%">
                                        </asp:DropDownList></td>
                                    <td style="width: 15%">
        ...
        <tr valign ="top">
            <td colspan="2">
                    ...
                    <Selecting AllowRowSelect ="True"  />
                     ...
                     <ExportSettings
                       HideStructureColumns="True" filename ="Entradas_Donaciones" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
                         <Pdf PageWidth="" >
                         </Pdf>
                    </ExportSettings>
