<%@ page title="" language="VB" masterpagefile="~/Controles/MasterPage.master" autoeventwireup="false" inherits="WebForms_SalidasEntregas, App_Web_if2ks1yr" %>
...
<script type="text/javascript">
    ...
    <asp:ValidationSummary ID="ValidationSummaryASIG" runat="server" ValidationGroup="ASIG" ForeColor="Red" style="text-align: left" />
    <asp:ValidationSummary ID="ValidationSummaryPROD" runat="server" ValidationGroup="PROD" ForeColor="Red" style="text-align: left" />
    <asp:ValidationSummary ID="ValidationSummaryFACT" runat="server" ValidationGroup="FACT" ForeColor="Red" style="text-align: left" />
            ...
            <tr valign="top">
                <td style="width: 75%" align="left"> 
                    <asp:Label ID="lbl_Titulo" runat="server" 
                        Text="SALIDA POR ENTREGAS" Width="90%" 
                    ...
                    <table id="tblContenido" class="EditControlsTable" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr  valign="top">
                            <td class="LabelCell" colspan="6" style="background-color: orange;">
                                <asp:Label ID="Label2" runat="server" Font-Bold="True">DATOS DE LA ORDEN DE SALIDA</asp:Label></td>
                        </tr>

                        <tr  valign="top">
                          <td  class="LabelCell" style="width: 17%">
                                <asp:Label ID="lblNumero_Factura_Proveedor" runat="server" Width="90%">No. Orden de Salida</asp:Label></td>
                            ...
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="lblbodega0" runat="server" Width="90%">Programación</asp:Label>
                        </td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="lbl_programa" runat="server" Width="90%">.</asp:Label>
                            </td>
                        </tr>
                        <tr  valign="top">
                            <td class="LabelCell" style="width: 17%">
                                <asp:Label ID="lblFecha0" runat="server" style="margin-bottom: 0px" Width="90%">Fecha</asp:Label>
                            </td>
                            <td class="ControlCell" style="width: 17%; ">
                                ...
                                <asp:RequiredFieldValidator ID="rfv_Fecha0" runat="server" 
                                    ControlToValidate="rdpfecha" EnableClientScript="False" 
                                    ErrorMessage="Falta Fecha de Entrega" ForeColor="Red" ValidationGroup="FACT">*</asp:RequiredFieldValidator>
                            </td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="lblNumero_Entrada0" runat="server" Width="90%">Grupo</asp:Label>
                            </td>
                            <td class="ControlCell" style="width: 17%; ">
                                <asp:DropDownList ID="ddl_grupo" runat="server" Font-Size="X-Small" Width="90%">
                                </asp:DropDownList>
                                <asp:RegularExpressionValidator ID="rev_grupo" runat="server" 
                                    ControlToValidate="ddl_grupo" EnableClientScript="False" 
                                    ErrorMessage="Falta Seleccionar el grupo" ForeColor="Red" 
                                    ValidationExpression="^[1-9]+[0-9]*$" ValidationGroup="FACT">*</asp:RegularExpressionValidator>
                            </td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:Label ID="lblIdentificacion_Entrego0" runat="server" Width="90%">Días</asp:Label>
                            </td>
                            <td class="ControlCell" style="width: 17%">
                                <asp:TextBox ID="txtdias" runat="server" Font-Size="X-Small" MaxLength="2" 
                                    onkeypress="return ValNumero(this, event)" Width="30%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfv_dias0" runat="server" 
                                    ControlToValidate="txtdias" ErrorMessage="Debe Digitar Número de Días" 
                                    ForeColor="Red" ValidationGroup="FACT">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr  valign="top">
                            <td class="LabelCell" style="width: 17%;">
                                <asp:Label ID="lblNombre_Entrego" runat="server" Width="90%">Nombre Entrega</asp:Label></td>
                            <td class="ControlCell" style="width: 17%; ">
                            ...
                            <td class="ControlCell" style="width: 17%;">
                                <asp:Label ID="lblbodega1" runat="server" Width="90%">Bodega</asp:Label>
                            </td>
                            <td class="ControlCell" style="width: 17%; ">
                            ...
                            <td class="ControlCell" style="width: 17%;">
                                <asp:Label ID="Label20" runat="server" Width="90%">Tipo de Entrega</asp:Label></td>
                            <td class="ControlCell" style="width: 17%;">
                                <asp:dropdownlist id="ddl_tipoEntrega" runat="server" Font-Size="X-Small" Width="90%" >
                                </asp:DropDownList>
                                <asp:RegularExpressionValidator ID="rev_Tipoentrega" runat="server" ControlToValidate="ddl_tipoEntrega"
                                    EnableClientScript="False" 
                                    ErrorMessage="Falta Seleccionar Tipo de Entrega" ValidationExpression="^[1-9]+[0-9]*$"
                                    ValidationGroup="FACT" ForeColor="Red">*</asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        ...
                        <tr  valign="top">
                            ...
                            <td class="ControlCell" colspan="5" style="width: 83%; text-align: left;">
                         ...
                         <tr style="background-color: #F7F7F7;" >
                            <td align="center" colspan="6">
                                <div ID="div_Botones_Principales" runat="server">
                        ...
                        <tr  valign="top"><td  class="LabelCell" style="background-color: orange;" colspan="6">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True">PRODUCTOS DEL DOCUMENTO DE SALIDA</asp:Label></td>
                        </tr>
                              ...
                              <table runat="server" id="tbl_ingreso" width="100%" style="border-right: lightslategray thin solid; border-top: lightslategray thin solid; border-left: lightslategray thin solid; border-bottom: lightslategray thin solid; width: 100%;" border="0" cellpadding="0" cellspacing="0" >
                                  ...
                                  <tr  valign="top">
                                      <td class="ControlCell" colspan="2" style="background-color: lemonchiffon; width: 50%;" align="center" id="pnl_asignar">
                                          <div style="width: 100%; text-align: center;" id="div_asignacion" runat="server">
                            ...
                            <td  class="LabelCell" colspan="6" align="right">
                                <telerik:RadGrid ID="Rg_Listado" runat="server" AllowSorting="True" GridLines="None" Skin="WebBlue" Width="100%" OnItemCommand="subCommandItem" 
                                    ...
                                    <ClientSettings EnablePostBackOnRowClick="True" EnableRowHoverStyle ="True"  >
                                     ...
                                     <ExportSettings
                                       HideStructureColumns="True" filename ="SalidasDetalleEntregas" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
                                ...
                                <div runat="server" id="divnuevo" align="center" >
                                    <asp:Button ID="btn_nuevo_producto" runat="server" CssClass="Boton" Text="Nuevo Producto" Width="200px" />
                                </div>
                            </td>
                        ...
                        <tr  valign="top"><td  class="LabelCell" style="background-color: #ff6633; text-align: center;" colspan="6">
                            <asp:Label ID="Label4" runat="server" Font-Bold="True">FIN DE LA SALIDA DE LA ENTREGA</asp:Label></td>
                        </tr>
